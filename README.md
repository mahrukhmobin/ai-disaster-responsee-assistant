...
**Live Demo:** [Try it here](https://huggingface.co/spaces/Mahrukhh/disaster_ai_chatbot)
...
| GPS-Aware | Detects user location and fetches local emergency numbers |
| Image Classification | Upload disaster images, classified using Hugging Face model |
| Safety Tips | Tailored guidance for earthquakes, floods, fires & more |
...
| Geopy + TimezoneFinder | GPS and location detection |
...
## Supported Countries and Emergency Numbers
...
| Member | Role |
|--------|------|
| Mahrukh Mobin | GUI, core Python code, GPS/location features |
...
| Zoya Rabail | Code integration and deployment |
